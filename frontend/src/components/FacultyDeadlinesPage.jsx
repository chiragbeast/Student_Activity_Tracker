                ...
                {deadlines.length > 0 ? deadlines.map(d => (
                    <div key={d._id} className={styles.deadlineCard}>
                        ...
                        <div className={styles.deadlineMeta}>
                            <div className={styles.metaItem}>
                                <Users size={14} />
                                <span>{d.assignedStudents?.length || 0} Students Assigned</span>
                            </div>
                        </div>
                    </div>
                )) : (
                        ...
                        <form onSubmit={handleCreate} className={styles.form}>
                            ...
                            <div className={styles.studentSelector}>
                                <div className={styles.selectorHeader}>
                                    ...
                                    >
                                        {formData.assignedStudents.length === filteredStudents.length && filteredStudents.length > 0 ? (
                                ...
                                <div className={styles.studentList}>
                                    {filteredStudents.length > 0 ? filteredStudents.map(s => (
                                        ...
                                        <div className={styles.noStudents}>
                                            <p>{searchTerm ? 'No students match your search.' : 'No students assigned to you.'}</p>
                                        </div>
                                    )}
                                </div>
                            </div>
                            ...
                            <div className={styles.modalFooter}>
                                ...
                                <div className={styles.btnGroup}>
                                    ...
                                    <button type="submit" className={styles.submitBtn}>Create & Notify</button>
                                </div>
                            </div>
                        </form>
                    </div>
